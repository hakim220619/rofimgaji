                        ...
                        <div class="col-md-4">
                            <div class="mb-3 position-relative">
                                ...
                                <input type="text" class="form-control" id="owner" name="owner"
                                    value="{{ $aplikasi->nama_owner }}" placeholder="Owner" required>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3 position-relative">
                                ...
                                <input type="text" class="form-control" id="telephone" name="telephone"
                                    placeholder="Telephone" value="{{ $aplikasi->tlp }}" required>
                                <div class="valid-tooltip">
                                    Looks good!
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3 position-relative">
                                ...
                                <input type="text" class="form-control" id="version" name="version"
                                    placeholder="Version" value="{{ $aplikasi->versi }}" required>
                                <div class="valid-tooltip">
                                    Looks good!
                                </div>
                            </div>
