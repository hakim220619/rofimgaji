...
<div class="p-3">
    <p class="text-muted text-center">Sign in to {{ Helper::apk()->title }}.</p>
...
{{ Helper::apk()->copy_right }} <script>document.write(new Date().getFullYear())</script> {{ Helper::apk()->title }} <span class="d-none d-sm-inline-block"> with Version {{ Helper::apk()->versi }} by {{ Helper::apk()->nama_owner }}.</span>
</div>
